...
export default function EditEventoModal({ evento, onClose, onSuccess }: EditEventoModalProps) {
    ...
    useEffect(() => {
        ...
        setFormData({
            ...
            colorFondoQR: evento.colorFondoQR || '#FFFFFF',
            coordenadaYQR: evento.coordenadaYQR || 336,
            coordenadaXQR: evento.coordenadaXQR || 100,
            coordenadaYDatos: evento.coordenadaYDatos || 631,
            coordenadaXDatos: evento.coordenadaXDatos || 65,
            dimensionQR: evento.dimensionQR || 122,
        });
    }, [evento]);
